...
# Los resultados son iguales a cero, debido a que no hay nadie que escanee QRs.

#Un problema que puede ocurrir, esque el programa no tenga acceso a la página de administración de QRs.
#Esto se debe a que con el plan gratis solo dura 14 días la suscripción y el acceso a QRs. Pero con una cuenta registrada pagando anualmente 
